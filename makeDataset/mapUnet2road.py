...
DATA_DIR = '/home/hua/pys/segmentation_models.pytorch/data/triRoad256/'  # 256
# DATA_DIR = '/home/hua/pys/segmentation_models.pytorch/data/triRoad320/'  # 320
...
for i in range(0, 10):
    ...
    if max_score < valid_logs['iou_score']:
        ...
        torch.save(model, 'roadE10_256.pth')   #  range()
        print('Model saved!')

    #     if i >=20:  #range(40)
    #         nlr = 0.0001 - (i-19)*0.0000045  #  to 0.00001
    # if i >=15:  # range(20)
    #     nlr = 0.0001 - (i-14)*0.000015   # to 0.000025
    # if i >= 20:  # range(50)
    #     nlr = 0.0001 - (i - 19) * 0.000002833  # to 0.000015
    if i >=20:  # range(30)
        nlr = 0.0001 - (i-19)*0.000008    # to 0.00002
...
'''
best_model = torch.load('../makeDataset/roadFull30_320.pth')  # created by server
