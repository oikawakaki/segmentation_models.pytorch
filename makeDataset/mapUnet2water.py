...
# DATA_DIR = '/home/hua/pys/segmentation_models.pytorch/data/water240_320p80/'
DATA_DIR = '/home/hua/pys/segmentation_models.pytorch/data/triWater256/'
...
for i in range(0, 15):
    ...
    if max_score < valid_logs['iou_score']:
        ...
        torch.save(model, 'waterE15_256.pth')
        print('Model saved!')

    if i >=10:
        nlr = 0.0001 - (i-9)*0.000015  # for 15, down to 0.000025
        optimizer.param_groups[0]['lr'] = nlr
        print('decoder learning rate ', nlr)
    # if i >=15:
    #     nlr = 0.0001 - (i-14)*0.000015  # for 20, down to 0.000025
    #     optimizer.param_groups[0]['lr'] = nlr
    #     print('decoder learning rate ', nlr)
    # if i >=20:
    #     nlr = 0.0001 - (i-19)*0.0000045  # for 40
    #     optimizer.param_groups[0]['lr'] = nlr
    #     print('decoder learning rate ', nlr)
...
best_model = torch.load('../makeDataset/waterE15_256.pth')  # created by server
